...
export default function RoomDetailsScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    mainContainer: { flex: 1, backgroundColor: theme.colors.surface },
    scrollView: { flex: 1 },
    ...
    content: {
      ...
      backgroundColor: theme.colors.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: -20,
    },
    titleSection: { marginBottom: 20 },
    roomName: { fontSize: 24, fontWeight: '700', color: theme.colors.text, marginBottom: 8 },
    ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 6 },
    ratingText: { fontSize: 14, fontWeight: '700', color: theme.colors.text },
    ...
    featureItem: {
      width: 96, height: 100, backgroundColor: theme.colors.primaryLight,
      borderRadius: 14, padding: 12, alignItems: 'center', justifyContent: 'center',
    },
    featureIconBox: { marginBottom: 6 },
    featureLabel: { fontSize: 11, fontWeight: '600', color: theme.colors.text, textAlign: 'center' },
    featureSublabel: { fontSize: 9, color: theme.colors.textSecondary, textAlign: 'center' },
    tabBar: {
      flexDirection: 'row', borderBottomWidth: 1,
      borderBottomColor: theme.colors.border, marginBottom: 20,
    },
    tabItem: {
      paddingVertical: 12, marginRight: 24,
      borderBottomWidth: 2, borderBottomColor: 'transparent',
    },
    activeTabItem: { borderBottomColor: theme.colors.primary },
    ...
    sectionTitle: { fontSize: 17, fontWeight: '700', color: theme.colors.text, marginBottom: 10 },
    description: { fontSize: 14, color: theme.colors.textSecondary, lineHeight: 22 },
    amenitiesGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
    amenityItem: {
      flexDirection: 'row', alignItems: 'center', width: '48%',
      backgroundColor: theme.colors.surfaceSecondary, padding: 12, borderRadius: 10, gap: 8,
    },
    amenityText: { fontSize: 12, color: theme.colors.textSecondary },
    locationContainer: {},
    locationTitle: { fontSize: 15, fontWeight: '700', color: theme.colors.text, marginBottom: 4 },
    locationSubtitle: { fontSize: 13, color: theme.colors.textSecondary, marginBottom: 16 },
    mapPlaceholder: {
      width: '100%', height: 160, backgroundColor: theme.colors.surfaceSecondary,
      borderRadius: 14, justifyContent: 'center', alignItems: 'center',
      borderWidth: 1, borderStyle: 'dashed', borderColor: theme.colors.borderLight,
    },
    mapText: { marginTop: 8, fontSize: 12, color: theme.colors.textTertiary },
    footer: {
    ...
    footerPrice: { fontSize: 20, fontWeight: '700', color: theme.colors.primary },
    reserveButton: {
      backgroundColor: theme.colors.primary, paddingHorizontal: 28, paddingVertical: 14,
      borderRadius: 14, shadowColor: theme.colors.primary,
      shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4,
    },
    reserveButtonText: { color: theme.colors.surface, fontSize: 15, fontWeight: '700' },
  }), [theme]);
